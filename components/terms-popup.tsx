...
export function TermsPopup() {
  ...
  return (
    <Dialog open={showTerms} onOpenChange={() => {}}>
      <DialogContent 
        className="bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] border-2 border-[#6b7280]/30 text-white max-w-[90vw] sm:max-w-lg md:max-w-2xl max-h-[75vh] sm:max-h-[80vh] overflow-hidden !top-[50%] !translate-y-[-50%] !mt-0 !mb-0"
        style={{
      ...
      >
        {/* Background effects */}
        <div className="absolute inset-0 bg-gradient-to-br from-[#6b7280]/5 via-transparent to-[#6b7280]/5" />
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#6b7280] via-[#9ca3af] to-[#6b7280]" />
        ...
        <DialogHeader className="relative z-10 pb-4 pt-2">
          <DialogTitle className="text-lg sm:text-2xl font-bold flex flex-col sm:flex-row items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-[#6b7280] to-[#9ca3af] flex items-center justify-center shadow-lg shadow-[#6b7280]/30">
        ...
        <div className="relative z-10 space-y-4 sm:space-y-5 px-1">
          ...
          <div className="bg-gradient-to-r from-[#6b7280]/10 to-[#9ca3af]/10 border border-[#6b7280]/30 rounded-xl p-3 sm:p-4">
            <div className="flex items-start gap-2 sm:gap-3">
              <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-[#6b7280]/20 flex items-center justify-center flex-shrink-0">
                <AlertTriangle className="w-3 h-3 sm:w-4 sm:h-4 text-[#6b7280]" />
              </div>
              <div>
                <h3 className="text-white font-semibold text-sm mb-1">Important Notice</h3>
                <p className="text-white/80 text-xs sm:text-sm leading-relaxed">
                  By using Ring-0, you acknowledge that gaming cheats may violate game terms of service. 
            ...
            <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm text-white/80 leading-relaxed">
              <div>
                <h4 className="text-white font-semibold mb-2 flex items-center gap-2 text-sm">
                  <FileText className="w-3 h-3 sm:w-4 sm:h-4 text-[#6b7280]" />
                  1. Acceptance of Terms
                </h4>
                <p>
                  By accessing and using Ring-0 ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. 
              ...
              <div>
                ...
                <p>
                  Permission is granted to temporarily download one copy of Ring-0 products for personal, non-commercial transitory viewing only. 
              ...
              <div>
                ...
                <p>
                  The materials on Ring-0 are provided on an 'as is' basis. Ring-0 makes no warranties, expressed or implied, 
        ...
        <DialogFooter className="relative z-10 pt-4 sm:pt-5 flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4">
          <Button
            ...
            className="w-full sm:flex-1 bg-gradient-to-r from-[#6b7280] to-[#9ca3af] hover:from-[#9ca3af] hover:to-[#6b7280] text-white font-semibold py-3 sm:py-4 px-6 rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg shadow-[#6b7280]/30 text-sm sm:text-base min-h-[44px]"
          >
