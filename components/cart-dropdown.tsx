  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#dc2626] to-[#ef4444] rounded-full opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-500" />

        <ShoppingCart className="w-6 h-6 relative z-10 transition-transform group-hover:rotate-12" />

        {/* Animated Counter Badge */}
        {cartCount > 0 && (
          <span className="absolute -top-1 -right-1 min-w-[22px] h-[22px] px-1 bg-gradient-to-br from-[#dc2626] to-[#b91c1c] text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg shadow-red-500/50 animate-pulse border-2 border-black">
            {cartCount > 9 ? "9+" : cartCount}
            {/* Ping Effect */}
            <span className="absolute inset-0 rounded-full bg-[#dc2626] animate-ping opacity-75" />
          </span>
        )}
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute right-0 top-full mt-3 w-[420px] bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl shadow-2xl shadow-black/50 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div
              className="absolute inset-0 rounded-2xl opacity-50 blur-xl bg-gradient-to-r from-[#dc2626] via-[#ef4444] to-[#dc2626] animate-pulse"
              style={{ zIndex: -1 }}
            />

            {/* Header with Gradient */}
            <div className="relative flex items-center justify-between p-5 border-b border-[#1a1a1a] bg-gradient-to-r from-[#dc2626]/10 to-transparent">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#dc2626] to-[#b91c1c] flex items-center justify-center shadow-lg shadow-red-500/30">
                ...
                {cartCount > 0 && (
                  <span className="ml-1 px-2 py-0.5 bg-[#dc2626]/20 text-[#dc2626] text-xs font-bold rounded-full border border-[#dc2626]/30">
            ...
            {items.length === 0 ? (
              <div className="p-12 text-center">
                <div className="relative inline-block mb-4">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#dc2626] to-[#ef4444] rounded-full blur-2xl opacity-20 animate-pulse" />
              ...
              <>
                  ...
                  {items.map((item, index) => (
                    <div
                      ...
                      className={
                        ...
                        hover:border-[#dc2626]/50 transition-all duration-300 group
                    ...
                    >
                      ...
                      <div className="relative w-20 h-20 rounded-xl overflow-hidden bg-[#1a1a1a] flex-shrink-0 group-hover:shadow-lg group-hover:shadow-[#dc2626]/20 transition-all duration-300">
                        <Image
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-[#dc2626]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                      </div>

                      {/* Product Details */}
                      <div className="flex-1 min-w-0">
                        <h4 className="text-white font-semibold text-sm truncate group-hover:text-[#dc2626] transition-colors">
                          {item.productName}
                        </h4>
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <span className="text-transparent bg-gradient-to-r from-[#dc2626] to-[#ef4444] bg-clip-text font-bold text-base">
                      ...
                      <button
                        ...
                        className="text-white/30 hover:text-red-400 hover:bg-red-500/10 p-2 rounded-lg transition-all duration-200 self-start hover:scale-110 active:scale-95 group/btn"
                      >
                ...
                <div className="p-5 border-t border-[#1a1a1a] space-y-4 bg-gradient-to-b from-transparent to-[#0a0a0a]">
                  ...
                  >
                    ...
                    {/* Glow Effect */}
                    <div className="absolute inset-0 -z-10 blur-xl bg-gradient-to-r from-[#dc2626] to-[#ef4444] opacity-50 group-hover/link:opacity-75 transition-opacity" />
                  </Link>
