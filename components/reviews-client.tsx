      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#6b7280]/10 border border-[#6b7280]/20 rounded-full mb-6">
            ...
            <span className="text-[#6b7280] text-sm font-semibold">Verified Customer Reviews</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 tracking-tight">
            <span className="block mb-2">What Our</span>
            <span className="relative inline-block">
              <span className="text-[#6b7280]">Customers Say</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-8 hover:border-gray-500/30 transition-all text-center">
              <div className="w-16 h-16 rounded-full bg-gray-500/10 flex items-center justify-center mx-auto mb-4">
                <Users className="w-8 h-8 text-gray-400" />
              </div>
              <p className="text-6xl font-bold text-gray-400 mb-2">{totalReviews.toLocaleString()}</p>
          ...
          <div className="group relative">
            ...
            <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-8 hover:border-[#6b7280]/30 transition-all text-center">
              ...
              <p className="text-6xl font-bold text-[#6b7280] mb-2">{ratingDistribution?.[5] || 0}</p>
                ...
                return (
                  <div key={stars} className="flex items-center gap-4">
                    ...
                    <div className="flex-1 h-3 bg-[#0a0a0a] rounded-full overflow-hidden border border-[#1a1a1a]">
                      <div 
                        className="h-full bg-gradient-to-r from-[#6b7280] to-[#9ca3af] rounded-full transition-all duration-500"
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl text-white placeholder:text-white/40 focus:border-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#6b7280]/20 transition-all"
                />
                {searchQuery && (
                  <button
                ...
                <button
                  ...
                  className={`px-4 py-3 rounded-xl font-semibold transition-all ${
                    filterRating === null
                      ...
                      : "bg-[#0a0a0a] border border-[#1a1a1a] text-white/60 hover:text-white hover:border-[#6b7280]/30"
                  }`}
                >
                  All
                </button>
            ...
            <div>
              ...
              <select
                ...
                className="px-4 py-3 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl text-white focus:border-[#6b7280] focus:outline-none focus:ring-2 focus:ring-[#6b7280]/20 transition-all cursor-pointer"
              >
          ...
          {(filterRating !== null || searchQuery !== "") && (
            <div className="mt-4 pt-4 border-t border-[#1a1a1a] flex items-center justify-between">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {filterRating !== null && (
                  <span className="px-3 py-1 bg-[#6b7280]/20 border border-[#6b7280]/30 rounded-lg text-[#6b7280] text-sm font-medium">
                    {filterRating} stars
                  </span>
                )}
                {searchQuery && (
              ...
              <button
                ...
                className="text-white/60 hover:text-[#6b7280] text-sm font-medium transition-colors"
              >
                Clear all
              </button>
            </div>
        ...
        {filteredReviews.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {filteredReviews.map((review, index) => (
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-[#6b7280]/20 to-transparent rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-500" />
                <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-6 hover:border-[#6b7280]/30 transition-all h-full flex flex-col">
                  {/* Quote Icon */}
                  <div className="absolute top-6 right-6 opacity-10">
                    <Quote className="w-12 h-12 text-[#6b7280]" />
                  </div>
          ...
          <div className="relative group">
            ...
            <div className="relative text-center py-20 bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl">
              ...
              <button
                onClick={clearFilters}
                className="px-6 py-3 bg-gradient-to-r from-[#6b7280] to-[#9ca3af] hover:from-[#9ca3af] hover:to-[#6b7280] text-white rounded-xl font-semibold transition-all hover:shadow-lg hover:shadow-[#6b7280]/30"
              >
                Clear Filters
              </button>
            </div>
        ...
        <div className="relative group mt-16">
          ...
          <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border-2 border-[#6b7280]/30 rounded-2xl p-10 overflow-hidden text-center">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#6b7280]/10 border border-[#6b7280]/30 rounded-full mb-6">
                <Sparkles className="w-4 h-4 text-[#6b7280] animate-pulse" />
                <span className="text-[#6b7280] text-sm font-semibold">Join Thousands of Happy Customers</span>
              </div>
              ...
              <a
                href="/store"
                className="inline-flex items-center gap-3 bg-gradient-to-r from-[#6b7280] to-[#9ca3af] hover:from-[#9ca3af] hover:to-[#6b7280] text-white px-10 py-4 rounded-xl font-bold transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#6b7280]/40"
              >
                Browse Products
