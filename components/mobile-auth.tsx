      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 flex-1 min-w-0">
            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#6b7280] to-[#9ca3af] flex items-center justify-center text-white text-sm font-bold overflow-hidden flex-shrink-0">
              {user.avatarUrl ? (
                <Image
          ...
          <button
            ...
            className="flex items-center justify-center w-8 h-8 rounded-lg bg-gray-500/10 hover:bg-gray-500/20 text-gray-400 hover:text-gray-300 transition-all min-h-[32px] min-w-[32px]"
            title="Sign out"
          >
        ...
        <Link
          href="/account"
          className="flex items-center justify-between p-3 bg-[#6b7280]/10 hover:bg-[#6b7280]/20 border border-[#6b7280]/30 hover:border-[#6b7280]/50 rounded-lg transition-all"
        >
