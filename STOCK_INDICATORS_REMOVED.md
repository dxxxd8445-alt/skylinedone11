...
{selectedTier.stock !== undefined && (
  <div className="flex items-center gap-2 px-3 py-1.5 bg-[#0a0a0a]/50 rounded-lg border border-[#1a1a1a]">
    <div className={`w-2 h-2 rounded-full ${selectedTier.stock > 0 ? 'bg-green-400' : 'bg-red-400'}`} />
...
{tier.stock !== undefined && (
  <div className="flex items-center gap-2 text-xs">
    <div className={`w-2 h-2 rounded-full ${tier.stock > 0 ? 'bg-green-400' : 'bg-red-400'}`} />
