...
-- INSERT INTO admin_audit_logs (event_type, actor_role, actor_identifier, ip_address, user_agent) VALUES
-- ('login', 'admin', 'admin', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36'),
-- ('login', 'staff', 'staff@example.com', '192.168.1.100', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)');
