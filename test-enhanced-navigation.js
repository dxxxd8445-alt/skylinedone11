...
const hasDesktopEnhancements = headerContent.includes('group-hover:scale-110') && 
                              ...
                              headerContent.includes('bg-gradient-to-r from-[#dc2626] to-[#ef4444]') &&
...
const hasGlowEffects = headerContent.includes('group-hover:from-[#dc2626]/10') && 
                      headerContent.includes('group-hover:to-[#ef4444]/10') &&
                      headerContent.includes('bg-gradient-to-r from-[#dc2626]/0');
