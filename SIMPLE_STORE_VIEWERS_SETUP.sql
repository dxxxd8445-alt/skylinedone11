-- SIMPLE STORE VIEWERS SETUP
-- Run this SQL in your Supabase SQL Editor if you haven't run the advanced setup yet

-- 1. Create basic visitor_sessions table (if it doesn't exist)
...
-- 2. Create basic page_views table (if it doesn't exist)
...
-- 3. Create basic conversion_events table (if it doesn't exist)
...
-- Success message
SELECT 'Simple Store Viewers setup completed successfully!' as status;