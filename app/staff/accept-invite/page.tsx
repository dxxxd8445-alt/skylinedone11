    ...
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="bg-[#111111] border border-[#262626] rounded-xl p-8 max-w-md w-full">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#6b7280] to-[#9ca3af] flex items-center justify-center mx-auto mb-4">
            <Flame className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-white mb-2">Welcome to Ring-0</h1>
        ...
        <Button
          ...
          className="w-full bg-[#6b7280] hover:bg-[#9ca3af] text-white h-12 text-base font-semibold"
        >
          {submitting ? (
            <>
