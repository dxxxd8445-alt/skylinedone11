      ...
      <div className="relative w-full max-w-md z-10 animate-in fade-in slide-in-from-bottom duration-700">
        <div className="flex flex-col items-center justify-center mb-10">
          <div className="relative group">
            ...
            <div className="relative p-5 bg-gradient-to-br from-[#6b7280] to-[#b91c1c] rounded-2xl shadow-2xl shadow-blue-500/50 transform transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="flex items-center justify-center gap-2 px-4 py-1.5 bg-[#6b7280]/10 border border-[#6b7280]/30 rounded-full">
              ...
              <span className="text-xs font-semibold text-[#6b7280] uppercase tracking-wider">Team Access Portal</span>
            </div>
          </div>
        </div>
          ...
          <div className="relative">
            <div className="text-center mb-8">
              <div className="inline-flex items-center justify-center gap-2 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#6b7280]/20 to-[#b91c1c]/20 border border-[#6b7280]/30 flex items-center justify-center">
            ...
            {error && (
              <div className="flex items-start gap-3 p-4 bg-gray-500/10 border border-gray-500/30 rounded-xl text-gray-400 animate-in fade-in shake mb-6">
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  />
                  <div className="relative">
                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/40 group-hover:text-[#6b7280] transition-colors" />
                    <input
                      type="email"
                      value={email}
                      ...
                      className="w-full pl-12 pr-4 py-4 bg-[#111111] border border-[#1a1a1a] rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-[#6b7280] focus:ring-2 focus:ring-[#6b7280]/20 transition-all font-medium"
                    />
              ...
              <div className="flex items-center gap-2 p-3 bg-gray-500/5 border border-gray-500/20 rounded-lg">
                ...
                <p className="text-xs text-gray-400/80">Tip: Use your staff credentials provided by your administrator</p>
              </div>
