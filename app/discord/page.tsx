    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <main className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#1a1a1a] to-[#0a0a0a] pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#6b7280]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1s" }} />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#6b7280]/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "0.5s" }} />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 py-8 lg:py-16">
          ...
          <div className="text-center mb-12 lg:mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="p-4 rounded-2xl bg-gradient-to-br from-[#6b7280] to-[#9ca3af] shadow-2xl shadow-[#6b7280]/30">
            ...
            <p className="text-xl md:text-2xl text-white/70 mb-8 max-w-3xl mx-auto leading-relaxed">
              Connect with our community, get instant support, and stay updated with the latest from Ring-0
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <a
                ...
                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#6b7280] to-[#9ca3af] hover:from-[#9ca3af] hover:to-[#6b7280] text-white font-bold text-lg rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl shadow-[#6b7280]/30 hover:shadow-[#6b7280]/50 min-w-[280px] justify-center"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-6 hover:border-[#6b7280]/30 transition-all h-full">
          ...
          <div className="relative group mb-16">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-[#6b7280]/20 to-[#6b7280]/20 rounded-3xl blur opacity-0 group-hover:opacity-100 transition duration-500" />
            <div className="relative bg-gradient-to-br from-[#111111] to-[#0a0a0a] border border-[#1a1a1a] rounded-3xl p-8 lg:p-12">
              <div className="text-center mb-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#6b7280]/10 rounded-full text-[#6b7280] text-sm font-semibold mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {benefits.map((benefit, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 p-4 rounded-xl bg-[#0a0a0a]/50 border border-[#1a1a1a] hover:border-[#6b7280]/30 transition-all group/item"
