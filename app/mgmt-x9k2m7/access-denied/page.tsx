...
export default function AccessDeniedPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0a0a0a] flex items-center justify-center p-4">
      <Card className="bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] border-2 border-[#2563eb]/20 max-w-md w-full">
        <CardContent className="p-8">
          <div className="text-center space-y-6">
            {/* Icon */}
            <div className="relative mx-auto w-20 h-20">
              <div className="absolute inset-0 bg-[#2563eb]/20 rounded-full blur-xl animate-pulse" />
              <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-[#2563eb]/20 to-[#3b82f6]/10 border-2 border-[#2563eb]/30 flex items-center justify-center">
                <ShieldAlert className="w-10 h-10 text-[#2563eb]" />
              </div>
            </div>
