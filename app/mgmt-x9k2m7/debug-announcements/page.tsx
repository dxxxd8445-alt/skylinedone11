      ...
      <div className="bg-[#1a1a1a] border border-[#262626] rounded-xl p-6">
        ...
        {error && (
          <div className="bg-gray-500/10 border border-gray-500/30 rounded-lg p-4 mb-4">
            <h3 className="text-gray-400 font-semibold mb-2">Error:</h3>
          ...
          <div className="space-y-4">
            <div className={`p-4 rounded-lg border ${
              ...
              <h3 className={`font-semibold mb-2 ${
                result.success ? 'text-green-400' : 'text-gray-400'
              }`}>
                    ...
                    <div key={ann.id} className="bg-[#0a0a0a] rounded p-3 mb-2">
                      <div className="flex items-center gap-2 mb-1">
                        <span className={`px-2 py-1 rounded text-xs font-medium ${
                          ann.type === 'info' ? 'bg-gray-500/20 text-gray-400' :
        ...
        <div className="mt-6 p-4 bg-gray-500/10 border border-gray-500/30 rounded-lg">
          <h3 className="text-gray-400 font-semibold mb-2">Next Steps:</h3>
