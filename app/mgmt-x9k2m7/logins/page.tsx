...
export default function ManageLoginsPage() {
  ...
  return (
    <AdminShell title="Customer Logs" subtitle="View customer accounts, activity, and order history">
      ...
      {/* Info banner */}
      <div className="mb-6 flex items-start gap-3 rounded-xl bg-[#6b7280]/10 border border-[#6b7280]/20 p-4">
        <UserCog className="w-5 h-5 text-[#6b7280] flex-shrink-0 mt-0.5" />
        <div>
                      ...
                      <tr key={u.id} className="border-b border-[#262626]/50 hover:bg-white/[0.02] transition-colors">
                        <td className="py-4 px-5">
                          <Avatar className="h-10 w-10 rounded-full ring-2 ring-[#262626]">
                            ...
                            <AvatarFallback className="bg-[#6b7280]/20 text-[#6b7280] font-semibold text-sm">
                        ...
                        <td className="py-4 px-5">
                          <div className="flex items-center gap-2">
                            ...
                            <a href={`mailto:${u.email}`} className="text-white font-medium hover:text-[#6b7280] transition-colors truncate max-w-[180px]" title={u.email}>
                              {u.email}
                            </a>
                          </div>
                        </td>
                        ...
                        <td className="py-4 px-5">
                          <Badge variant="secondary" className={cn(
                            "bg-white/5 border border-white/10 text-white/80",
                            u.licenses_count > 0 && "bg-gray-500/10 border-gray-500/20 text-gray-400"
                          )}>
                            {u.licenses_count}
                          </Badge>
                        </td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] border border-[#262626] shadow-xl p-6 sm:p-8">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-lg bg-[#0a0a0a] border border-[#262626] text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#6b7280]/50"
            />
            <div className="flex gap-2 mt-4">
              <Button variant="outline" className="flex-1 border-[#262626] text-white/80" onClick={() => { setResetModal(null); setNewPassword(""); }}>
                Cancel
              </Button>
              <Button className="flex-1 bg-[#6b7280] hover:bg-[#b91c1c] text-white" onClick={handleReset} disabled={resetting}>
          ...
          <div className="w-full max-w-5xl rounded-2xl bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] border border-[#262626] shadow-xl p-6 sm:p-8 my-8">
            <div className="flex items-start justify-between gap-4 mb-6">
              <div className="flex items-center gap-4 min-w-0">
                <Avatar className="h-16 w-16 rounded-xl ring-2 ring-[#6b7280]/30 flex-shrink-0">
                  {viewModal.avatar_url ? (
                    <AvatarImage src={viewModal.avatar_url} alt={viewModal.username} className="object-cover" />
                  ) : null}
                  <AvatarFallback className="bg-[#6b7280]/20 text-[#6b7280] font-semibold text-xl rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-gradient-to-br from-[#0a0a0a] to-[#111111] border border-[#262626] rounded-xl p-4">
                <div className="flex items-center justify-between">
                  ...
                  <ShoppingCart className="w-8 h-8 text-gray-400/30" />
                </div>
              </div>
            ...
            {detailLoading ? (
              <div className="py-16 flex flex-col items-center justify-center gap-4">
                <div className="w-12 h-12 rounded-full border-2 border-[#6b7280]/30 border-t-[#6b7280] animate-spin" />
                          ...
                          <div key={o.id} className="p-4 hover:bg-white/[0.02] transition-colors">
                            <div className="flex flex-wrap items-center justify-between gap-3">
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="w-10 h-10 rounded-lg bg-gray-500/10 border border-gray-500/20 flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="text-right">
                                  ...
                                  <Badge 
                                    ...
                                    className={cn(
                                      ...
                                      o.status === 'failed' && "bg-gray-500/10 border-gray-500/20 text-gray-400"
                                    )}
                                  >
                                    {o.status}
                                  </Badge>
                                  ...
                                  <div className="flex items-center gap-3 mt-1">
                                    <Badge 
                                      ...
                                      className={cn(
                                        ...
                                        l.status === 'expired' && "bg-gray-500/10 border-gray-500/20 text-gray-400",
                                        l.status === 'used' && "bg-gray-500/10 border-gray-500/20 text-gray-400"
                                      )}
                                    >
                                      {l.status}
                                    </Badge>
