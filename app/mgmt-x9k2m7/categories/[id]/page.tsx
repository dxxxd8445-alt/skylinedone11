    ...
    <AdminShell>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          {category && (
            <div className="bg-gradient-to-r from-[#6b7280]/10 to-transparent border border-[#6b7280]/20 rounded-xl p-6">
        ...
        {!loading && products.length === 0 && (
          <div className="text-center py-12 bg-[#111111] border border-[#1a1a1a] rounded-xl">
            ...
            <Link href="/mgmt-x9k2m7/products">
              <Button className="bg-[#6b7280] hover:bg-[#9ca3af] text-white">
