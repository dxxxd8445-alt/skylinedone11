        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          {loading ? (
            <div className="text-center py-20">
              <Loader2 className="w-16 h-16 text-[#6b7280] animate-spin mx-auto mb-6" />
            ...
            <div className="text-center py-20">
              ...
              <Link
                href="/cart"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#6b7280] hover:bg-[#9ca3af] text-white rounded-xl font-semibold transition-all"
              >
                Return to Cart
              </Link>
            </div>
            ...
            <div className="text-center py-20">
                ...
                <div className="space-y-4">
                  ...
                  {sessionId && (
                    <div className="pt-4 border-t border-[#1a1a1a]">
                      ...
                      <p className="text-[#6b7280] font-mono text-sm">{sessionId}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-[#6b7280] to-[#9ca3af] hover:from-[#9ca3af] hover:to-[#6b7280] text-white rounded-xl font-bold transition-all hover:scale-105"
                >
              ...
              <div className="mt-12 p-6 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-[#6b7280] hover:text-[#9ca3af] font-semibold transition-colors"
                >
