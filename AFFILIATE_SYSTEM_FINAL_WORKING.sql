-- ============================================================================
-- AFFILIATE SYSTEM - COMPLETE SETUP (WORKING VERSION)
-- ============================================================================
-- This script sets up the complete affiliate system with all required tables,
-- columns, indexes, and RLS policies. Run this in Supabase SQL Editor.
-- ============================================================================

-- STEP 1: Add missing columns to affiliates table
...
-- STEP 2: Copy existing data from user_id to store_user_id
UPDATE affiliates SET store_user_id = user_id WHERE store_user_id IS NULL AND user_id IS NOT NULL;

-- STEP 3: Create unique constraint on store_user_id
ALTER TABLE affiliates ADD CONSTRAINT IF NOT EXISTS affiliates_store_user_id_unique UNIQUE (store_user_id);
...
-- STEP 5: Drop old restrictive RLS policies
...
-- STEP 7: Create affiliate_referrals table
...
-- STEP 8: Create affiliate_clicks table
...
-- STEP 9: Create categories table
...
-- STEP 10: Create indexes for referrals, clicks, and categories
...
-- STEP 12: Create permissive RLS policies for all tables
...
-- STEP 13: Insert all 19 game categories
...
-- Check affiliates table has all required columns
...
-- SETUP COMPLETE
-- ============================================================================
-- If you see no errors above, the affiliate system is ready to use!
-- You can now:
