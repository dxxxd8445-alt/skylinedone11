...
try {
  ...
  if (templatesExist) {
    ...
    test('Magma branding in templates', templatesContent.includes('🔥 Ring-0'));
    test('Red theme colors (#6b7280)', templatesContent.includes('#6b7280'));
    ...
    test('Discord support links', templatesContent.includes('discord.gg/ring-0'));
  ...
  if (forgotPageExists) {
    ...
    test('Consistent Magma styling', forgotPageContent.includes('#6b7280') || forgotPageContent.includes('bg-[#6b7280]'));
  ...
  if (teamInviteExists) {
    ...
    test('Consistent styling', teamInviteContent.includes('#6b7280'));
  ...
  existingFiles.forEach(file => {
    ...
    if (!content.includes('#6b7280') && !content.includes('bg-[#6b7280]') && !content.includes('blue-600')) {
